          ...
          <div className="pt-32 pb-20 md:pt-40 md:pb-44">
            ...
            <div className="max-w-xl mx-auto md:max-w-none md:flex md:items-center md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-16 md:space-y-0">
              ...
              <div className="text-center md:text-left md:min-w-[30rem]" data-aos="fade-right">
                <h1 className="h1 font-playfair-display text-slate-100 mb-4">Buscando Serviços de qualidade?</h1>
                <p className="text-xl text-slate-400 mb-8">Mais de 10 anos de experiencia em serviços nas area de segurança e controle de acesso.</p>
